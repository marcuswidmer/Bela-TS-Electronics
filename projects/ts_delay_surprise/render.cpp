...
static void processResamplerBackground(void*) {
    resampler.process(delay.line, delay.line, delay.delayTime);
}
...
bool setup(BelaContext *context, void *userData)
{
    ...
    gResampleTask = Bela_createAuxiliaryTask(&processResamplerBackground, 90, "fft-calculation");
